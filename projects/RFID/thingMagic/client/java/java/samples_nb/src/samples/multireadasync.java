...
public class multireadasync
{
    ...
    static void usage()
    {
        System.out.printf("Usage: Please provide valid arguments, such as:\n"
                + "  (URI: 'tmr:///COM1 --ant 1,2' or 'tmr:///COM1 --ant 1,2 tmr:///COM2 --ant 1,2' "
                + "or 'tmr://M6-2100d3/ --ant 1,2 tmr:///COM1 --ant 1,2')\n\n");
        System.exit(1);
    }
    ...
    public static void main(String argv[])
    {
        ...
        try
        {
            ...
            for (String reader: readerPort.keySet())
            {
                ...
                String model = r[i].paramGet("/reader/version/model").toString();
                if ((model.equalsIgnoreCase("M6e Micro") || model.equalsIgnoreCase("M6e Nano")) && readerPort.get(reader) == null)
                {
