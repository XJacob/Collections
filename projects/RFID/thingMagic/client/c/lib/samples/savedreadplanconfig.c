/**
 * Sample program that demonstrates SaveReadPlan config along with Autonomous read.
 * @file Savedreadplanconfig.c
 */
...
int main(int argc, char *argv[])
{
  ...
  if ((0 == strcmp("M6e", model.value)) || (0 == strcmp("M6e PRC", model.value))
    || (0 == strcmp("M6e Micro", model.value))  || (0 == strcmp("M6e Nano", model.value)) || (0 == strcmp("M6e Micro USB", model.value))|| (0 == strcmp("M6e Micro USBPro", model.value))) 
  {
